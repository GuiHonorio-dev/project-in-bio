...
import { ArrowUpFromLine, DiscAlbum, Plus } from "lucide-react";
...
export function NewProject({ profileId }: {profileId: string}) {
  ...
  return (
    <>
      <button onClick={handleOpenModal} className="w-[400px] h-[155px] rounded-[20px] bg-background-secondary flex items-center gap-2 justify-center hover:border border-dashed">
          ...
          <div className="flex gap-10"  >
            ...
            <div className="flex flex-col gap-4 w-[293px]">
              ...
              <div className="flex flex-col gap-1">
                ...
                <TextArea id="project-description" placeholder="De uma breve descrição do seu projeto" className="h-36"/>
              </div> 
              <div className="flex flex-col gap-1">
