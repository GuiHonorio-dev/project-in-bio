  ...
  return (
    <div className="w-fit flex flex-col gap-5 items-center p-5 border border-white border-opacity-10 bg-[#121212] rounded-3xl text-white">
      <div className="size-48">
        <img src={await getDownloadURLFromPath(profileData?.imagePath) || "https://github.com/guihonorio-dev.png"} alt="Foto de perfil" className="rounded-full object-cover size-full" />
      </div>
      <div className="flex flex-col gap-2 w-full">
        <div className="flex items-center gap-2">
          <h3 className="text-3xl font-bold min-w-0 overflow-hidden">{profileData?.name || "Guilherme Honorio"}</h3>
          {
