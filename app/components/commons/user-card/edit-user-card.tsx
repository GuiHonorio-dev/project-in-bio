        ...
        <div className="bg-background-primary p-8 rounded-[20px] flex flex-col justify-between gap-10">
          ...
          <div className="flex gap-10">
            <div className="flex flex-col items-center gap-3 text-xs">
              <div className="w-[100px] h-[100px] rounded-xl bg-background-tertiary overflow-hidden">
                ...
                />
                  ...
                  <button onClick={() => triggerImageInput("profile-pic-input")} className="size-full">
                    100x100
                  </button>
                ) }
              ...
              <input type="file" id="profile-pic-input" className="hidden" accept="image/*" onChange={(e) => setProfilePic(handleImageInput(e))} />
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <TextArea placeholder="Fale um pouco sobre voce" className="h-36" value={yourDescription} onChange={(e) => setYourDescription(e.target.value)} />
            </div>  
            </div>
          </div>
